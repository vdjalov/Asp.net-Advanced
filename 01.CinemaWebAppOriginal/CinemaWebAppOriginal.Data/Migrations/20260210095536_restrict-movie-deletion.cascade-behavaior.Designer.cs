...
namespace CinemaWebAppOriginal.Data.Migrations
{
    ...
    [Migration("20260210095536_restrict-movie-deletion.cascade-behavaior")]
    partial class restrictmoviedeletioncascadebehavaior
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaWebAppOriginal.Data.Models.CinemaMovie", b =>
                {
            ...
            modelBuilder.Entity("CinemaWebAppOriginal.Data.Models.UserMovie", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CinemaWebAppOriginal.Data.Models.CinemaMovie", b =>
                {
                    ...
                    b.HasOne("CinemaWebAppOriginal.Data.Models.Movie", "Movie")
                        .WithMany("CinemaMovies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CinemaWebAppOriginal.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
